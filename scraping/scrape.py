...
keywords = {'memorization': ['llm', 'language model', 'memorization', 'memorized', 'privacy', 'eidetic', 'extractibility', 'forgetting'],
            'attacks': ['llm', 'language model', 'privacy', 'attack', 'membership inference', 'shadow model', 'threshold', 'extraction'],
            'inference': ['llm', 'language model', 'privacy', 'attack', 'membership inference', 'shadow model', 'threshold', 'extraction'],
            'extraction': ['llm', 'language model', 'privacy', 'attack', 'membership inference', 'shadow model', 'threshold', 'extraction'],
            'private': ['llm', 'language model', 'privacy preserving', 'private', 'differential privacy', 'federated learning', 'federated averaging'],
            'privacy': ['llm', 'language model', 'privacy preserving', 'private', 'differential privacy', 'federated learning', 'federated averaging'],
...
for category in keywords:
    ...
    for result in results:
        ...
        if category in ['inference','extraction']:
            cat = 'attacks'
...
results_df = results_df[results_df.relevance > 5]
results_df = results_df.drop_duplicates(subset=['title'], keep=False)
